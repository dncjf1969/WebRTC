...
class TestComponent extends Component {
    constructor(props) {
        ...
        let tempNamelist = [ "이정123", "우처리", "young남", "조소히", "현아짱99","동준은쌈디", "나는우철", "나는용남", "소힝", "현아입니다", "" ];
        let userName = tempNamelist [Math.floor(Math.random() * 10)];   
        
        let imgList2 = [ require("./testImages/muzi.PNG"), require("./testImages/muzi.PNG"), require('./testImages/neo.PNG'), require('./testImages/prodo.PNG'),require('./testImages/prodo.PNG') ];
        this.remotes = [];
        ...
        this.setState(
            ...
            () => {
                ...
                this.state.session.on('connectionCreated', (event) => {
                    ...
                    var temp = { "userName" : temp2.clientData, "sessionID" : event.connection.connectionId, "ReadyState" : false};
                    ...
                    {
                        var temp3 = "name" + i;
                        var tempHtml = `<img src= "`+ this.state.imgList[i]+ `" style="float: left;
                        width:100px;
                        height:100px"/>` +
                        `<div>`+ this.state.nowUser[i].userName + `</div>` +
                        `<div id="ready`+ i +`" style="font-size:14pt"> 준비 중.. </div>`;
...
//                            document.getElementById(temp3).innerHTML = "준비!";
                ...
                this.state.session.on('signal:makeQues', (event) => {
                    ...
                    var yy = event.data; 
                    document.getElementById("quesList").innerHTML += `<div style="border: 1px solid black; float:left; width:380px"> <div style="font-size:17pt; margin-left:3px; float:left">`+ event.data+`</div> <div style="float:right">` +zz +`</div> </div>`;
    ...
    leaveSession() {
        ...
        this.setState({
            ...
            tempNamelist : [ "이정정", "우처리", "young남", "조소히", "hyuna55","동준은쌈디", "나는우철", "용남", "소힝", "현아입니다" ],
