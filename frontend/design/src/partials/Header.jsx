        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow ">
            <ul  className="flex flex-grow justify-end flex-wrap items-center">
              {jwtToken ? 
              <li>
                <button  onClick={handleLogout} className="py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">로그아웃</button>
              </li>
              :
              <li>
                <Link to="/login" className=" btn-sm py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 shadow hover:shadow-lg ">로그인</Link>
              </li>
              }
              ...
              <li className='flex items-center'>
                ...
                :
                <li>
                <Link to="/signup" className="btn-sm shadow hover:shadow-lg font-semibold focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75 rounded-lg text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
                  <span >회원가입</span>
