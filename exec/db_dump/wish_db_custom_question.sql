...
CREATE TABLE `custom_question` (
  ...
  `meetingroom_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `custom_question` WRITE;
/*!40000 ALTER TABLE `custom_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_question` ENABLE KEYS */;
UNLOCK TABLES;
